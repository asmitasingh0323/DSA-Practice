...
| :--- | :--- |
| **Arrays & Hashing** | Frequency analysis, sliding windows, and prefix sums. |
| **Linked Lists** | In-place manipulation and pointer-based logic. |
| **Trees & Graphs** | BFS/DFS, topological sorting, and shortest path algorithms. |
